...
testfile4 = "1_1_MMStack_1-Pos_000_000.ome"


loadme_working = os.path.join(indir4, testfile4)
...
wellDict_working = filenamesToDict(indir4)
#wellDict_broken = filenamesToDict(indir1, wellNames1)

#wellDict3 = filenamesToDict(indir3, wellNames3)

stitchWellsOnDisk(wellDict_working, indir4, outdir, 0.5)
stitchWellsInRAM(wellDict_working, indir4, outdir, 0.5)
